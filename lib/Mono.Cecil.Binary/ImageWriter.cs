...
namespace Mono.Cecil.Binary {
	...
	internal sealed class ImageWriter : BaseImageVisitor {
		...
		public ImageWriter (MetadataWriter mdw, BinaryWriter writer)
		{
			m_img = mdw.GetMetadataRoot ().GetImage ();
