...
namespace Mono.Cecil.Metadata {
    ...
    internal sealed class ImplMapRow : IMetadataRow {
        ...
        [Column] private PInvokeAttributes m_mappingFlags;
        [Column] private MetadataToken m_memberForwarded;
        [Column] private uint m_importName;
        [Column] private uint m_importScope;
